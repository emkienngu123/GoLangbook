...
class bittorrent_client():
    ...
    def __init__(self, user_arguments):
        ...
        self.client_request = {'seeding' : None,               'downloading': None,
                               ...
                               'max peers' : 4, 'local_leechers' : None}
        ...
        #local leechers mode: 
        if user_arguments[LOCAL_LEECHER]:
            self.client_request['local_leechers'] = True
    ...
    def initialize_swarm(self):
        ...
        if self.client_request['local_leechers']:
            peers_data['peers'] = [('localhost',6881)]
            peers_data['seeders'] = 1
